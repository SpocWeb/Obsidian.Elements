...
columns:
  ...
  Electronegative:
    input: number
    accessorKey: Electronegative
    label: Electronegative
    key: Electronegative
    id: Electronegative
    position: 14
    skipPersist: false
...
config:
  ...
  row_templates_folder: _/Element
